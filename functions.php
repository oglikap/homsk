...
add_action( 'wp_enqueue_scripts', 'roadtrip_scripts');
...
// Custom menu
function wpb_roadtrip_menu() {
  register_nav_menu('roadtrip-menu',__('Roadtrip Menu'));
}
add_action( 'init', 'wpb_roadtrip_menu');
